...
- It sets the **embedding table** and, via [[Weight tying]], the output projection.
- Its **special tokens** matter — `<|endoftext|>` for document boundaries, and `<think>`/`</think>` for [[Chain-of-thought]] reasoning traces in [[Phase 3 - Code pretraining and SFT]].
...
## Connects to
[[Byte-level BPE]] · [[Subword tokenization]] · [[Weight tying]] · [[Chinchilla scaling laws]] · [[pass@k]] · [[Chain-of-thought]]
